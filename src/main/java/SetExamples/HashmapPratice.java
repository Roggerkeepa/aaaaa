...
//Create  a class with name HashmapPractise and
//create object of hashmap setting key with following name :
// name, rollno, designation, mobileno and assign value to all these key
